...
import yinian.hx.api.RestAPIInvoker;
import yinian.hx.invoker.HttpClientRestAPIInvoker;
import yinian.hx.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
	...
	private static final String BASE_PACKAGE = "yinian.hx.api.impl";
