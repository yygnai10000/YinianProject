...
public class PictureVerifyThreadNew extends Thread{
	...
	public PictureVerifyThreadNew(String userid,int eid, String main) {
		this.eid = eid;
		this.main = main;
		this.userid=userid;
	}
	...
	public void run() {
		...
		if(!picList.isEmpty()) {
			...
			//图片鉴黄
			picArr = dataProcess.PictureVerifyByLy(picArr);
			//被过滤的图片根据pid更新图片地址
