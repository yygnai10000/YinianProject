...
public class VerifyPictureNew extends Thread {

	private String[] picArray;
	private int from;
	private int end;

	public VerifyPictureNew(String[] picArray, int from, int end) {
	...
	public void run() {
		...
		for (int i = from; i <= end; i++) {
			...
			if (suffix.equals("gif")) {
				...
				// 执行鉴黄
				String address = operate.getDownloadToken(picArray[i] + "?qpulp");
