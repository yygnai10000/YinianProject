...
import yinian.model.TwoDimensionCodeImage;
...
public class TwoDimensionCode {
	...
	public static void main(String[] args) {
		...
		String encoderContent = "http://wx.zhuiyinanian.com/shop/playaudio?src=http://7xlmtr.com1.z0.glb.clouddn.com/9253198f-ba8b-4368-8fc3-62d9c3ead6ee.mp3&goodsid=1&from=yinian";
		TwoDimensionCode handler = new TwoDimensionCode();
		handler.encoderQRCode(encoderContent, imgPath, "png");
		BufferedImage image = handler.qRCodeCommon(encoderContent, "png", 100);
